...
DROP TABLE IF EXISTS connection_protection_logs;
DROP SEQUENCE IF EXISTS connection_protection_logs_id_seq;

CREATE SEQUENCE connection_protection_logs_id_seq INCREMENT 1 MINVALUE 1 MAXVALUE 2147483647 START 1 CACHE 1;

CREATE TABLE connection_protection_logs
(
